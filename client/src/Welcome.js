...
import './welcome.css';
import MadeByMaxIcon from "./images/MadeByMaxIcon";
  ...
  <div className="welcome">
    <header className="welcome__top">
      <a
        ...
        href={`https://${document.domain}/email_messages/`}
      >
        <img src={logo} alt="React Logo" className="welcome__logo"/>
      </a>
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="https://github.com/yalagin"
      >
        <MadeByMaxIcon/>
        {/*<Flag/>*/}
      </a>
    ...
    <section className="welcome__main">
      ...
      <div className="main__content">
        <h1>
          Welcome to <strong>Database Archive </strong>!
        </h1>
        <div className="main__before-starting">
          <p>
            This container host a {' '}
            <a href={`https://${document.domain}`}><b>Progressive Web App</b></a>. <br/>
            there are 3 main thing. <br/>
            <a href={`https://${document.domain}/email_messages/`}><b>Email archive</b></a>
            {' '} The task that you assign me {' '}
            <a
              href={`https://challenge.hennge.com/challenge-details/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOlsieWFsYWdpbkBnbWFpbC5jb20iXSwiaXNzIjoiaGVubmdlLWFkbWlzc2lvbi1jaGFsbGVuZ2UiLCJzdWIiOiJjaGFsbGVuZ2UifQ.6ouPxOC_6-bjG58eJHniXBCUxmmIe6NJgvLElOuge8Y`}>
              <b>description</b>
            </a>
            <br/>
            <a href={`https://${document.domain}:8443`}><b>API</b></a>
            {' '}with postgres DB for data fetching made with PHP and Symofny Framework.<br/>
            {' '}just for convenient adding new emails to database <br/>
          </p>
          <a
            // target="_blank"
            // rel="noopener noreferrer"
